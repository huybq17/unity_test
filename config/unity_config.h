...
#include "sl_iostream.h" // Thêm thư viện để sử dụng USART

// Định nghĩa hàm gửi ký tự qua USART
#define UNITY_OUTPUT_CHAR(a)                    sl_iostream_write(sl_iostream_vcom_handle, (char *)&a, 1)
#define UNITY_OUTPUT_CHAR_HEADER_DECLARATION    void UNITY_OUTPUT_CHAR(int a)
// #define UNITY_OUTPUT_FLUSH()                    // Không cần flush trong trường hợp này
// #define UNITY_OUTPUT_FLUSH_HEADER_DECLARATION   void UNITY_OUTPUT_FLUSH(void)
// #define UNITY_OUTPUT_START()                    // Có thể thêm khởi tạo USART nếu cần
// #define UNITY_OUTPUT_COMPLETE()                 // Có thể thêm đóng USART nếu cần
